...
const onSubmit = async (data) => {
  try {
    ...
    const res = await axios.post("http://localhost:5000/api/users/register", datas);
    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen py-10">
            ...
            >
                ...
                <FormInput label={"City *"} placeholder="City" name="city" register={register} />
                <FormInput label={"Post Code *"} placeholder="Post Code" name="postcode" register={register} />
                <FormInput label={"Address *"} placeholder="Address" name="address" register={register} />
                <FormInput
                    label={"Password *"}
                    type="password"
